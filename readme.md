...
```bash
capable-web               # Browser UI on localhost:8000
capable-api               # REST API on localhost:8080
```
...
# Custom port
capable-web --port 9000
```

### API Server — `capable-api`
...
capable-api --host 0.0.0.0 --port 8080
```
...
└── capable_core/             # Main package
    ...
    ├── cli.py                      # ADK wrappers (capable-web, capable-api)
